<div class="container-xxl py-5">
            <div class="container px-lg-5">
                <div class="section-title position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Nuestros miembros del equipo</h1>
                    <p class="mb-1">Con un grupo de ingenieros altamente capacitados, con las mejores herramientas para llevar a cabo cualquier solución.</p>
                </div>
                <div class="row g-4">
